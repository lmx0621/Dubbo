...
def paser():
    for key, value in method().items():
        ...
        if os.path.exists('%s.ini' % key):
            ...
            with open("outputlogaaa.txt", 'a+') as f:
                f.write(".........................................打开文件{}.ini.........................................\n".format(key))
            # 读取配置文件
                ...
                for i in range(len(fields_table_param)):
                    ...
                    #root节点取不到值，就执行下面步骤
                        ...
                        for j in optionalRoots_response_value:
                            if j in hive_value:
                                ...
                                with open("outputlogaaa.txt", 'a+') as f:
                                    f.write("{} 字段在json中的值为{}，在hive数据库的值为{}\n".format(fields_table_param[i], optionalRoots_response_value,hive_value))

                    #如果字段为queryTime，将时间戳转化为年月日时分秒，然后将hive里的时间由unicode转化成utf8格式
                        ...
                        if queryTime in hive_value[0].encode("utf-8"):
                            ...
                            with open("outputlogaaa.txt", 'a+') as f:
                                f.write("{} 字段在json中的值为{}，在hive数据库的值为{}\n".format(fields_table_param[i], queryTime, hive_value[0].encode("utf-8")))
                    # root节点和optionalRoots_response节点都取不到值，就执行下面步骤
                        ...
                        for j in optionalRoots_request_value:
                            if j in hive_value:
                                ...
                                with open("outputlogaaa.txt", 'a+') as f:
                                    f.write("{} 字段在json中的值为{}，在hive数据库的值为{}\n".format(fields_table_param[i], optionalRoots_request_value,hive_value))
                    ...
                    #其他字段为空则默认通过
                        ...
                        if "None" in str(hive_value):
                            ...
                            with open("outputlogaaa.txt", 'a+') as f:
                                f.write("{} 字段在hive数据库的值为{}\n".format(fields_table_param[i],hive_value))
