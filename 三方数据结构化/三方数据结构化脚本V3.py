    ...
    for key, value in method().items():
        ...
        if os.path.exists('%s.ini' % key):
            ...
            for table_name in table_list:
                ...
                optionalRoots_request = conf.get(table_name, "optionalRoots_request")
                optionalRoots_response = conf.get(table_name, "optionalRoots_response")
